...
Throughout, I'll refer to the `scooby` data set, originally sourced from [kaggle](https://www.kaggle.com/datasets/thedevastator/the-unsolved-mysteries-of-scooby-doo) but modified slightly for use in my vids and posts. A download link can be found at the end of this post.
