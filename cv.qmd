...
This is an experimental reverse-chronological narration of my career path and learning journey. Click [here](/cv/Gard-CV-2024.pdf) to download a less interesting old-school CV, but in that case you might also take a moment to read a little about the problematic nature of [professionalism](https://ssir.org/articles/entry/the_bias_of_professionalism_standards).

## Research 

I'm a polymath researcher, broadly interested in a wide variety of quantitative and sociological phenomena which I explore via a neverending stream of mentored undergraduate research projects. My primary personal focus is in the area of quantitative botany, where I design and apply tools that aid conservationists and land managers as they evaluate the health and progress of natural sites. 

{{< video https://youtu.be/yptZbKvTjBw >}}
...
![](assets/lfc_logo2.jpg){style="float: right; margin: 5px;" width=140}
...
In this role, I spearhead the statistics track of the DS major, focusing on R programming and mathematical probability/statistics. Because my Ph.D is in pure mathematics, I'm also able to support students with that focus, teaching and mentoring all levels of undergraduate math.
...
Everything was very ad hoc for me back then, but I've learned a ton since and upgraded my production values substantially (note to self: a how-to page for youtubers in education etc). These days, Equitable Equations specializes in #Rstats and closely-related topics in machine learning and computer science and boasts well over 40,000 subscribers. My most popular vid will cross a million views soon. 

{{< video https://youtu.be/yZ0bV2Afkjc>}}

In the spring of 2025, in part reflecting my growing understanding of the Almighty YouTube Algorithm, I made the decision to begin a second channel which would offer full courses in statistics and machine learning, allowing *Equitable Equations* to focus more narrowly on R. *Normal Knowledge* soft-launched that May, with a more official release still expected this fall. 
...
I tried on a number of different hats before starting graduate school, some relevant to my current work, some not. I reviewed books for the Columbus Dispatch and Cleveland Plain Dealer back when local newspapers were a thing. I was a part-time data analyst for a public-opinion research company. I worked nights at a Red Roof Inn (ask me about that one if you see me). And I played bass in an indie rock band for awhile. 

The cliche goes that life is short, but this hasn't been my experience. Life is long, and there's time enough to be different people over time if have the desire and your circumstances allow. Those people live inside me now, all of them speaking at once inside a modestly wise, very nerdy, middle aged head. 
