...
This is a reverse-chronological narration of my career path and learning journey. Click [here](/cv/Gard-CV-2024.pdf) to download a less interesting old-school CV, but if you do, please also take a moment to read a little about [professionalism](https://ssir.org/articles/entry/the_bias_of_professionalism_standards).
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Vl5ZMWzAPaE?si=H4Si55JKQDl_qvS7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
